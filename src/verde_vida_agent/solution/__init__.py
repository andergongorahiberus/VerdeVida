...
``verde_vida_agent.solution`` (this package)
...
::
    ...
    from verde_vida_agent.solution.observability import process_query, get_langfuse_client
    from verde_vida_agent.solution.prompt_provider import get_system_prompt, FALLBACK_PROMPT
...
from verde_vida_agent.solution.observability import get_langfuse_client, process_query
