...
Usage:
    python -m verde_vida_agent.cicd.evaluate_prompt --label staging
    python -m verde_vida_agent.cicd.evaluate_prompt --label staging --threshold 0.8
...
This script calls verde_vida_agent.evaluation.run_evaluation() which uses
...
Examples:
  python -m verde_vida_agent.cicd.evaluate_prompt --label staging
  python -m verde_vida_agent.cicd.evaluate_prompt --label staging --threshold 0.8
  python -m verde_vida_agent.cicd.evaluate_prompt --label staging --json
        """,
    )
    parser.add_argument(
        "--label",
