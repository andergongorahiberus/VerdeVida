...
Usage:
    python -m verde_vida_agent.cicd.push_prompt \\
...
Examples:
  # From a file
  python -m verde_vida_agent.cicd.push_prompt --file prompts/system_prompt.txt --labels staging latest

  # Inline content
  python -m verde_vida_agent.cicd.push_prompt --content "Eres Alex..." --labels staging

  # With metadata
  python -m verde_vida_agent.cicd.push_prompt --file prompts/v2.txt --labels staging --author "dev-team"
        """,
    )
