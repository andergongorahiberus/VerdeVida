...
Usage:
    python -m verde_vida_agent.cicd.promote_prompt --from-label staging --to-label production
...
Examples:
  python -m verde_vida_agent.cicd.promote_prompt --from-label staging --to-label production
  python -m verde_vida_agent.cicd.promote_prompt --from-label latest --to-label staging
        """,
    )
    parser.add_argument(
        "--from-label",
