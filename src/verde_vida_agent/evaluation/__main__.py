"""CLI entry point: python -m verde_vida_agent.evaluation"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m verde_vida_agent.evaluation --label staging
  python -m verde_vida_agent.evaluation --label staging --threshold 0.8
  python -m verde_vida_agent.evaluation --label production --json
        """,
    )
    parser.add_argument(
        "--label",
