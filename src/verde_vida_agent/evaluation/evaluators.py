"""Evaluadores deterministas y agregadores run-level — Verde Vida Nursery Agent.
...
FAQ_EVIDENCE_KEYWORDS: list[str] = [
    ...
    "envío", "devoluc", "pago", "horario", "cuidados",
    "lunes", "sábado", "tarjeta", "política", "planta",
    "fitosanitari", "embalaje", "cuotas",
